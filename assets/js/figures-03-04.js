...
export function renderFig03(mount, data) {
  ...
  stages.forEach(([value, label], index) => {
    ...
    svg.append(svgEl('text', { x, y: 338, 'text-anchor': 'middle', class: 'p4-filter-label' }, label));
  });
...
export function renderFig04(mount, data) {
  ...
  axisLayer.append(svgEl('text', { x: 20, y: plot.y + plot.h / 2, transform: `rotate(-90 20 ${plot.y + plot.h / 2})`, 'text-anchor': 'middle', class: 'p4-axis-label' }, 'Discharge Q (m³/s)'));
